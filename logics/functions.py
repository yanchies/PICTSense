...
def visualise(df):
    ...
    neg_issues = df[df['sentiment'].between(1, 4)]['topic'].value_counts().sort_values('count', ascending=False)
    pos_issues = df[df['sentiment'].between(6, 10)]['topic'].value_counts().sort_values('count', ascending=False)
