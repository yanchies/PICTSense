...
st.write("""
         MINDEF/SAF collects large volumes of survey responses such as from the Post-In-Camp Training Surveys (PICTS). 
...
with st.expander("Data Sources"):
    st.write("The project utilises open-ended responses from the PICTS collected in 2023. The data is classified as RESTRICTED.")
...
with st.expander("Features"):
    ...
    st.write("Topic Identification: Individual responses will be embedded to identify the most relevant topic from a pre-determined list of 9 topics.")
